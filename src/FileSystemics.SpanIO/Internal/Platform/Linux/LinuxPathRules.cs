...
internal sealed class LinuxPathRules : INativePathRules<LinuxPathRules> {
    private LinuxPathRules() {
    }
    ...
    public static StringComparison PathComparison => StringComparison.Ordinal;

    public static bool UsesUtf16NativePaths => false;

    public static bool UsesGetdents64DirectoryEnumeration => true;
